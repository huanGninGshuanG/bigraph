...
public class ZTRuleFinish {
    ...
    /*
        xx:Device[o1:outername] ||xx:PEP[o1:outername, xx:outername, o2:outername].
            ($0 || xx:ActiveZone.(xx:Connection[o4:edge].(xx:UserInfo || xx:DeviceInfo || xx:DataTag) || $1)) ||
    ...
    */
    private void init(RandBigraphGenerator gen, Node conn, int idx) {
        ...
        Node connRedex = NodeGenerator.cloneNode(conn, bb, activeRedex);
        ...
        * */
        ...
        // 处理pdp
        Node pdpReact = NodeGenerator.cloneNode(pdpRedex, bb1, root1);
        ...
        // 处理device
        Node deviceReact = NodeGenerator.cloneNode(device, bb1, root1);
