...
public class NameGenerator {
    ...
    public String generate() {
        ...
        if (ref == null) {
            DebugPrinter.print(logger, "New local block for thread " + Thread.currentThread().getId() + "-" + Thread.currentThread().getName());
    ...
    private BigInteger getNewBlock(BigInteger size) {
        BigInteger block;
        synchronized (this) {
            DebugPrinter.print(logger, "Allocating a new block of size " + size.toString() + " for thread " + Thread.currentThread().getId() + "-" + Thread.currentThread().getName());
