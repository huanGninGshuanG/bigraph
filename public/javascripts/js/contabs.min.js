$(function () {
    ...
    function loadMenuItem() {
        ...
        //同时打开tabs个数限制
        var tabs = $(".page-tabs-content a").length;
        if (tabs < 15) {
        	...
        	CommonUtils.notify("warning", "请先尝试关闭一些页面，再打开新页面！", "4000");
        	k = false;
        }
        if (k) {
        		// layer.load(1, {
                ...
                var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + o + "?v=" + Math.random() + "&" + extra + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
    ...
    $(".J_menuItem").on("click", loadMenuItem);
